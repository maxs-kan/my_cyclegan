...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--intrinsic_mtrx_path', type=str, default='/all_data/Scannet/', help='path to intrinsic matrixs')
...
#         parser.add_argument('--img2depth_dir', type=str, default='./checkpoints/img2d_pretrain/', help='pretrain weights')
        ...
        parser.add_argument('--use_ada', action='store_true', default=False, help='use semantic')
        ...
        parser.add_argument('--use_cycle_disc_A', action='store_true', default=False, help='cycle img as example of fake img')
...
#         parser.add_argument('--use_semi_cycle_second', action='store_true', default=False, help='only 1 gen in backward for cycle loss')
        ...
        parser.add_argument('--use_inp_noise', action='store_true', default=False, help='spectral norm for Disc')
        parser.add_argument('--inp_A', type=str, default='img_depth', help='chooses which input for G_B. [depth | img_depth ]')
...
#         parser.add_argument('--input_nc_img_feature', type=int, default=32, help='# of chanels for img features')
        ...
        parser.add_argument('--n_gr', type=int, default=8, help='# of group for group norm')
        ...
        parser.add_argument('--upsampling_type', type=str, default='transpose', help='upsampling operation [upconv | transpose]')
