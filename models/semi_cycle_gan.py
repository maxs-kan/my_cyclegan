...
#                 self.loss_names.extend(['rec_semantic_A'])
        ...
        self.visuals_names = ['real_img_A', 'real_depth_A', #'cycle_fake_B',
...
#         self.loss_cycle_cycle = self.criterionL1(self.cycle_fake_B, self.fake_depth_B.detach()) * self.l_cycle_A
