...
class UpTranspose(nn.Module):
    def __init__(self,in_chanels, out_chanels, use_bias, opt):
        ...
        self.transposeconv = nn.ConvTranspose2d(in_chanels, out_chanels, kernel_size=2, stride=2, padding=0, output_padding=0, dilation=1, padding_mode='zeros', bias=False)
    def forward(self, x):
...
#     state_dict = torch.load(opt.net_d2e_weights, map_location=device)
#     net = define_G_d2e(opt)
...
# def define_G_d2e(opt):
#     input_nc = opt.input_nc_depth
#     output_nc = 1
#     ngf_depth_edge = opt.ngf_depth_edge
#     netG_d2e  = opt.netG_d2e
#     norm = opt.norm
...
#     if netG_d2e == 'unet_256': 
#         net = UnetGenerator(input_nc, ngf_depth_edge, output_nc)
#     else:
